...
func (c *anthropicClient) TranslateToCommand(ctx context.Context, input string) (string, error) {
    ...
    1. /eggs [quantity] [notes...] (e.g., "/eggs 120", "/eggs 150 3 cracked")
    ...
    - Convert units if necessary (e.g. if user says "30 trays of eggs", and a tray is 30 eggs, output "/eggs 900").
